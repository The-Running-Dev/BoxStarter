...
$global:stableVersionDownloadUri = 'https://www.binaryfortress.com/Data/Download/?package=displayfusion&log=101'
$global:stableVersionRegEx = '.*DisplayFusionSetup-([0-9\.\-]+)\.exe$'
