function Install-WebSite {
    ...
    param(
        ...
        [Parameter(Position = 1, Mandatory = $true, ValueFromPipelineByPropertyName = $true)][string] $physicalPath,
        [Parameter(Position = 2, Mandatory = $true, ValueFromPipelineByPropertyName = $true)][string] $webAppPath,
    ...
    #New-IISApplicationPool $appPool
    ...
    # Create the web site and set its application pool
    #New-IISSite $name $physicalPath $appPool
