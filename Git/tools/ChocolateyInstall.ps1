$arguments          = @{
    url             = 'https://github.com/git-for-windows/git/releases/download/v2.13.1.windows.1/Git-2.13.1-64-bit.exe'
    checksum        = 'FE834EC34B6CBDA5B973FB4A210998471451EFAA42FFE20D6B5DE197A95FFC13'
