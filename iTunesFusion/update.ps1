...
$global:stableVersionDownloadUri = 'https://www.binaryfortress.com/Data/Download/?package=itunesfusion&log=102'
$global:stableVersionRegEx = '.*iTunesFusionSetup-([0-9\.\-]+)\.exe$'
